...
export function AppShell(props: AppShellProps) {
  ...
  return (
    ...
    >
      ...
      {/* TerminalLayer + TerminalPortalProvider were retired in
            D6.4b along with the xterm.js renderer. GridTerminal is
            rendered directly inside its owning `PaneLeaf` instead of
            going through a global portal layer. */}
      ...
      {/* Terminal Recordings Panel was retired in D6.4b (depended
            on xterm.js). A future GridReplayer-based UI can re-attach
            at this site. */}
