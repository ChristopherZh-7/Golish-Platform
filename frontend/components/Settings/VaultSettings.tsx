...
import { ENTRY_TYPES, TYPE_LABEL_KEYS, useVaultForm } from "./hooks/useVaultForm";
                        ...
                        return (
                          ...
                          >
                            ...
                            >
                              ...
                              <span className="text-[8px] text-muted-foreground/30 flex-shrink-0 tabular-nums">
                                {timeStr}
                              </span>
                            ...
                            {!isExpanded && (entry.username || entry.notes) && (
                              <div className="flex items-center gap-3 px-3 pb-2 ml-[22px] text-[10px] text-muted-foreground/40">
                                ...
                                {entry.notes && (
                                  <span className="truncate max-w-[260px]">{entry.notes}</span>
                                )}
                              </div>
                            )}
                            {isExpanded && (
                                    ...
                                    <>
                                      ...
                                      <div className="flex flex-wrap gap-1">
                                        {entry.tags.map((tag) => (
                                          <span
                                            key={tag}
                                            className="text-[9px] px-1.5 py-0.5 rounded-full bg-accent/10 text-accent/70"
                                          >
                                            {tag}
                                          </span>
                                        ))}
