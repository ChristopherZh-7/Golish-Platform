...
const PROVIDER_COLORS: Record<string, { bg: string; border: string; dot: string }> = {
...
export function ProviderSettings({ settings, onChange }: ProviderSettingsProps) {
      ...
      case "openrouter":
        return (
          <div className="space-y-3.5">
            ...
            <OpenRouterProviderPreferencesSection settings={settings} onChange={onChange} />
          </div>
        );
  ...
  const getColor = (id: string) => PROVIDER_COLORS[id] ?? DEFAULT_COLOR;
