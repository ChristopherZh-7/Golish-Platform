    ...
    <div className="flex items-center gap-1 flex-shrink-0" onClick={(e) => e.stopPropagation()}>
      {isBusy ? (
        <div className="flex items-center gap-1.5">
          ...
          {progress && (
            <span className="text-[10px] text-accent/50 whitespace-nowrap max-w-[80px] truncate">
              {progress}
            </span>
          )}
          <button
        ...
        tool.executableReady === false ? (
          ...
          <button
            type="button"
            onClick={() => ctx.onUninstall(tool)}
            className="p-1 rounded text-muted-foreground/30 opacity-0 group-hover:opacity-100 hover:text-destructive transition-all"
          ...
          <div className="flex items-center gap-2">
            ...
            <span
              className={cn(
                ...
                tool.installed ? "text-foreground" : "text-foreground/60"
              )}
            >
              {tool.name}
            </span>
