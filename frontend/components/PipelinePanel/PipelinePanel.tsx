...
import {
  AlertTriangle, CheckCircle2, Download, GitBranch, Loader2,
  Plus, Save, Shield, Trash2, X, Database,
} from "lucide-react";
...
import { type PipelineStep, type Pipeline } from "@/lib/pentest/pipeline-types";
import { STEP_ICONS, DagCanvas } from "./DagComponents";
