...
export const ActivityBar = memo(function ActivityBar({
  ...
  return (
    <TooltipProvider delayDuration={200}>
      <div className="w-[48px] flex-shrink-0 h-full bg-background flex flex-col items-center border-r border-[var(--border-subtle)]">
        {/* macOS traffic lights spacer */}
        <div className="h-[34px] w-full titlebar-drag" />
