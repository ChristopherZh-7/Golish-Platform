...
| `ai-events/harness-handlers.ts` | harness_trace → store；`stage_run_org_progress` 解析所属 requestId，Candidate review/Attempt terminal/Wave consolidation与 Reporting trace只写 refresh hint |
