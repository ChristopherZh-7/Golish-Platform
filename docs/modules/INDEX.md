...
- `golish-pentest-app/pentest_bridge` and `golish-agent-app/ai` are current as of 2026-07-21 for the EAS discovery/fingerprint split: Naabu Connect owns server-bounded quick/standard/full port discovery, full uses fixed TCP 1-65535/rate 1000/600-second v2 manifest+receipt proof, Nmap consumes only confirmed-open ports for service/version fingerprints, the Gate independently rejects v2 recipe/manifest/receipt/output drift, and strict legacy Nmap v1 XML proof remains readable. Statuses remain ✅.
