...
| golish-agent-runtime | 高层 agent runtime（流式 loop + source-pinned restore + shared stage-fork Candidate Wave + 每公司持久 Company Controller滚动补位 + exact-gap repair/continuation） | [→](backend/golish-agent-runtime.md) | ✅ |
