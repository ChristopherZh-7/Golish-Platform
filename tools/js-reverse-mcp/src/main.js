...
import { McpServer, SetLevelRequestSchema, StdioServerTransport } from "./third_party/index.js";
...
function registerTool(tool) {
  if (tool.annotations.category === ToolCategory.NETWORK && args.categoryNetwork === false) {
    return;
  }
  server.registerTool(
    tool.name,
