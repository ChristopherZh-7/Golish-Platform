...
export const getWebSocketMessages = defineTool({
    ...
    schema: {
        ...
        frameIndex: zod
            ...
            .min(0)
            .optional()
            .describe('Get a single message by its frame index (0-based). Returns full detail for that message.'),
        direction: zod
        ...
        groupId: zod
            .string()
            .optional()
            .describe('Filter by group ID (A, B, C, ...). Run with analyze=true first to get group IDs.'),
        pageSize: zod
            .number()
            .int()
            .positive()
