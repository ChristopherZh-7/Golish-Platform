...
export function parseArguments(version, argv = process.argv) {
  const yargsInstance = yargs(hideBin(argv))
    ...
    .example([
      ["$0 --browserUrl http://127.0.0.1:9222", "Connect to an existing browser instance via HTTP"],
      [
      ...
      ["$0 --viewport 1280x720", "Launch Chrome with the initial viewport size of 1280x720px"],
      [
