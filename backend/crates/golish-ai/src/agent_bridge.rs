...
use super::llm_client::{
    ...
    create_xai_components, create_zai_sdk_components, rig_gemini_vertex, rig_zai_sdk,
    AgentBridgeComponents, AnthropicClientConfig, GeminiClientConfig, GroqClientConfig, LlmClient,
    NvidiaClientConfig, OllamaClientConfig, OpenAiClientConfig, OpenRouterClientConfig,
    SharedComponentsConfig, VertexAnthropicClientConfig, VertexGeminiClientConfig,
...
impl AgentBridge {
    ...
    /// Create a new AgentBridge for NVIDIA NIM with shared components config.
    #[allow(clippy::too_many_arguments)]
