//! Runtime abstraction for different execution environments (CLI, Tauri, etc.)
//!
//! This module provides the core trait and types for runtime implementations.
//! Concrete implementations (TauriRuntime, CliRuntime) are provided by the
//! golish-runtime crate.
