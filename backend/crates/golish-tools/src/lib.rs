...
//! - Depends on: golish-core (for foundation types)
...
//!
//! ```rust,ignore
//! use golish_tools::{ToolRegistry, FunctionDeclaration, build_function_declarations};
//!
...
// Re-export Tool trait from golish-core for backward compatibility
