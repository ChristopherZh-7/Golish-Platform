...
pub struct SidecarConfig {
    ...
    /// Directory for session storage (default: ~/.golish/sessions)
...
mod tests {
    ...
    fn test_sessions_dir_default() {
        ...
        assert!(
            dir.to_string_lossy().contains(".golish"),
            "Expected path to contain '.golish', got: {}",
            dir.display()
        );
        assert!(
