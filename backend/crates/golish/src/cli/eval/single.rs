...
//!   known model list.
//!
//! along with their parallel/sequential implementations (`run_sequential`,
//! `run_parallel`, `run_parallel_simple`) and the transcript pretty-printer
//! used when `--transcript` is passed on the command line.
...
use super::{color, metric_pass_threshold, EvalOutputOptions};
