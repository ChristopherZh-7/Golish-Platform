...
//! implementations. Local implementations from golish_tools and golish_core are
...
///
/// Provides `ToolRegistry` and related types from golish_tools.
pub mod tools {
    pub use golish_tools::{build_function_declarations, FunctionDeclaration, Tool, ToolRegistry};
}
...
/// types from golish_core::session.
pub mod session {
    pub use golish_core::session::{
