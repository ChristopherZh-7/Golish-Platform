...
//! the necessary HTTP client, and delegates to the library crate.

use chrono::{Duration, Utc};

use golish_vuln_intel::{
    self as intel, EntryRow, FeedRow, VulnEntry, VulnFeed,
    GithubPocResult, NucleiTemplateResult, BatchNucleiResult,
...
// ─── Helper: build GitHub client from settings ──────────────────────
