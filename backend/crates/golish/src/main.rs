...
async fn run_cli_async(args: Args) -> anyhow::Result<()> {
    ...
    if args.list_scenarios {
        golish_lib::cli::eval::list_scenarios();
        return Ok(());
    }

    #[cfg(feature = "evals")]
    if args.list_benchmarks {
        golish_lib::cli::eval::list_benchmark_options();
        return Ok(());
    }
    ...
    if let Some(ref benchmark) = args.benchmark {
        ...
        use golish_lib::cli::eval::EvalOutputOptions;
        use std::str::FromStr;
        ...
        return golish_lib::cli::eval::run_benchmark(
            benchmark,
    ...
    if args.eval {
        ...
        return golish_lib::cli::eval::run_evals(
    ...
    if args.openai_models {
        return golish_lib::cli::eval::run_openai_model_tests(
    ...
    if args.swebench {
        ...
        return golish_lib::cli::eval::run_swebench(
            filter,
            args.json,
            args.verbose,
            args.parallel,
