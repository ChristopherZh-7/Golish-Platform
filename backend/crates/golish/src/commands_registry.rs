...
#[allow(unused_imports)] // command wrapper macros are resolved by generate_handler!
use commands_facade::attack::*;
#[allow(unused_imports)]
use commands_facade::cleanup::*;
...
fn install_handlers(builder: tauri::Builder<tauri::Wry>) -> tauri::Builder<tauri::Wry> {
    builder.invoke_handler(tauri::generate_handler![
        ...
        ai_get_stage_team_read_model,
        ai_resolve_stage_team_recovery,
        ...
        kg_search_entities,
        kg_get_neighbors,
        knowledge_graph_query_scoped,
        knowledge_graph_rebuild_scope,
        get_context_summary,
        ...
        reset_loop_detector,
        // ── attack (durable Candidate review / resume / attempts) ─
        ...
        pentest_launch_tool,
        pentest_kill_tool,
        pentest_kill_all_tools,
        pentest_search_tools,
        pentest_get_command,
        pentest_build_command,
        pentest_check_runtime,
        pentest_check_tool_executable_permission,
        pentest_check_tools_executable_permissions,
        pentest_fix_tool_executable_permission,
        pentest_open_directory,
        pentest_update_config,
        pentest_get_config,
        pentest_get_categories,
        pentest_check_env_setup,
        pentest_install_runtime,
        pentest_cancel_runtime_install,
        pentest_uninstall_runtime,
        pentest_check_brew_outdated,
        pentest_list_installed_ruby,
        pentest_list_available_ruby,
        pentest_install_ruby_version,
        pentest_uninstall_ruby_version,
        pentest_set_default_ruby,
        pentest_create_file,
        pentest_open_url,
        pentest_fetch_github_releases,
        pentest_fetch_github_release,
        pentest_fetch_github_release_by_tag,
        pentest_check_tool_updates,
        pentest_fetch_github_repo_info,
        pentest_fetch_github_readme,
        pentest_analyze_github_tool,
        pentest_create_tool_package,
        pentest_update_tool,
        pentest_update_tool_executable,
        pentest_delete_backup,
        pentest_delete_tool,
        pentest_copy_to_toolpack,
        pentest_download_and_extract,
        pentest_cancel_download,
        pentest_find_tool_executables,
        pentest_list_tool_dir_files,
        pentest_rename_tool_dir,
        pentest_uninstall_tool_files,
        pentest_uninstall_brew_pkg,
        pentest_uninstall_gem_pkg,
        pentest_read_tool_config,
        pentest_save_tool_config,
        pentest_git_clone_tool,
        pentest_pip_install_tool,
        pentest_pip_install,
        pentest_pip_uninstall,
        pentest_conda_install_tool,
        pentest_resolve_python_path,
        pentest_resolve_java_path,
        pentest_install_requirements,
        pentest_check_requirements,
        pentest_list_dep_files,
        pentest_install_dep_file,
        pentest_browser_navigate,
        pentest_browser_resize,
        pentest_browser_hide,
        pentest_browser_show,
        pentest_browser_close,
        pentest_browser_go_back,
        pentest_browser_go_forward,
        pentest_set_system_proxy,
        pentest_clear_system_proxy,
        pentest_get_system_proxy,
        pentest_list_installed_java,
        pentest_list_available_java,
        pentest_install_java_version,
        pentest_uninstall_java_version,
        pentest_set_default_java,
        pentest_direct_install_jdk_msi,
        pentest_list_installed_node,
        pentest_list_available_node,
        pentest_install_node_version,
        pentest_uninstall_node_version,
        pentest_use_node_version,
        pentest_list_python_envs,
        pentest_list_available_python,
        pentest_create_python_env,
        pentest_delete_python_env,
        create_detached_window,
        close_detached_window,
        pentest_list_skills,
        pentest_read_skill,
        pentest_write_skill,
        pentest_delete_skill,
        ...
        organization_candidates_list,
        organization_candidates_upsert,
        organization_move,
        organization_delete,
        vault_list,
        vault_add,
        ...
        asset_intel_list_providers,
        asset_intel_lookup_company,
        asset_intel_hydrate,
        ...
        organization_recon_start_run,
        organization_recon_get_run,
        organization_recon_export_assets,
        organization_recon_export_current_assets,
        recon_backfill_real_ip,
        // ── intel_providers (ASM platforms · 0.zone / FOFA / Quake / ...) ─
        intel_list_providers,
        intel_test_connection,
        intel_query_provider,
        ...
        method_list_templates,
        method_start_project,
        method_list_projects,
        method_load_project,
        method_update_item,
        ...
        findings_update,
        findings_delete,
        findings_import_parsed,
        findings_add_evidence,
        findings_remove_evidence,
        findings_evidence_path,
        findings_deduplicate,
        findings_for_host,
        // ── vuln-intel ───────────────────────────────────────────
        intel_list_feeds,
        intel_add_feed,
        ...
        intel_match_targets,
        intel_search_github_poc,
        intel_search_nuclei_templates,
        intel_batch_search_nuclei_templates,
        ...
        scan_queue_save_all,
        scan_queue_remove,
        scan_queue_clear_completed,
        custom_rules_list,
        custom_rules_upsert,
        custom_rules_save_all,
        custom_rules_delete,
        notes_list,
        notes_add,
        notes_update,
        ...
        wiki_create_cve,
        kb_research_load,
        kb_research_save_turn,
        kb_research_set_status,
        kb_research_clear,
        vuln_link_get_all,
        vuln_link_get,
        vuln_link_add_wiki,
        vuln_link_remove_wiki,
        vuln_link_add_poc,
        vuln_link_update_poc,
        vuln_link_remove_poc,
        vuln_link_add_scan,
        vuln_link_remove_scan,
        vuln_link_add_poc_full,
        vuln_poc_list_cves,
        vuln_poc_list_unresearched,
        vuln_poc_stats,
        vuln_poc_set_verified,
        wiki_pages_grouped,
        wiki_pages_for_paths,
        wiki_suggest_for_cve,
        wiki_changelog_list,
        wiki_backlinks,
        wiki_stats_full,
        wiki_orphan_pages,
        ...
        conv_save_timeline,
        conv_load_timeline,
        conv_save_terminal_state,
        conv_load_terminal_states,
        conv_save_preferences,
        conv_load_preferences,
        conv_save_batch,
        plan_create,
        plan_get,
        plan_list,
        ...
        plan_delete,
        oplog_list,
        oplog_list_by_target,
        oplog_list_by_type,
        oplog_search,
        oplog_count,
        target_assets_list,
        api_endpoints_list,
        api_endpoints_untested,
        fingerprints_list,
        js_analysis_list,
        pentest_read_capture,
        pentest_read_capture_text,
        passive_scans_list,
        passive_scans_by_url,
        passive_scans_vulnerable,
        passive_scans_stats,
        target_security_overview,
        target_surface_hierarchy_get,
        target_surface_identity_backfill,
        scan_whatweb,
        scan_feroxbuster,
        sensitive_scan_start,
        sensitive_scan_stop,
        sensitive_scan_status,
        sensitive_scan_results,
        sensitive_scan_clear,
        sensitive_scan_confirm,
        sensitive_scan_default_paths,
        sensitive_scan_apply_verdicts,
        mcp_list_servers,
        mcp_list_tools,
        mcp_get_config,
