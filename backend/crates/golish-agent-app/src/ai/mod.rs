...
pub use commands::{
    ...
    retry_compaction, run_recon_pipeline, save_agent_definition, save_project_agent_mode,
    save_project_model, search_memories, seed_agents, send_ai_prompt_session,
    ...
    set_tool_policy, set_tool_policy_config, shutdown_ai_session, signal_frontend_ready,
