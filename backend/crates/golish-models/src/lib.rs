...
//! - Depends on: golish-settings (for AiProvider enum)
//! - Used by: golish-llm-providers, golish-ai
//!
//! # Model Sources
//!
...
//!
//! ```
//! use golish_models::{get_model, get_models_for_provider, ModelCapabilities, AiProvider};
//!
