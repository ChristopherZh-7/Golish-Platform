...
impl ModelCapabilities {
    ...
    /// Create capabilities for NVIDIA NIM models.
    ...
    /// Create capabilities for NVIDIA NIM large models (405B+).
    pub fn nvidia_large_defaults() -> Self {
        Self {
            supports_temperature: true,
            supports_vision: false,
            context_window: 128_000,
    ...
    /// Create capabilities for NVIDIA NIM small/edge models.
    pub fn nvidia_small_defaults() -> Self {
        Self {
            supports_temperature: true,
            supports_vision: false,
