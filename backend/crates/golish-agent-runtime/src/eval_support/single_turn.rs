    ...
    M: RigCompletionModel + Sync,
{
    ...
    let ctx = AgenticLoopContext {
        ...
        runtime_memory: None,
        investigation_asset_verification_tools: None,
        application_understanding_runtime: None,
        ...
        web_fetcher: None,
        target_intel_goal_shadow: crate::eval_support::select_goal_shadow(
            config.target_intel_goal_shadow.as_ref(),
            false,
        ),
        intel_public_adapter: config.intel_public_adapter.clone(),
        harness_stage: None,
        harness_authz: None,
