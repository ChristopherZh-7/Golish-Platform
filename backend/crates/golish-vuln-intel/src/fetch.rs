//! Feed fetching and enrichment: CISA KEV, NVD, RSS, CVSS enrichment.

use crate::types::VulnEntry;

pub fn merge_and_enrich(entries: Vec<VulnEntry>) -> Vec<VulnEntry> {
...
pub async fn enrich_missing_cvss(client: &reqwest::Client, entries: &mut [VulnEntry]) {
...
pub async fn fetch_cisa_kev(
    client: &reqwest::Client,
    url: &str,
) -> crate::VulnIntelResult<Vec<VulnEntry>> {
